...
const ourFileRouter = {
    ...
    .middleware(async ({ req })=>{
        ...
        if (!session || !session.user) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$uploadthing$2f$shared$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UploadThingError"]("Unauthorized");
        ...
        // ИСПРАВЛЕНО: Возвращаем URL файла для клиента
        return {
            uploadedBy: metadata.userId,
            url: file.url,
            ufsUrl: file.ufsUrl // Добавлено
        };
    })
};
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0feab35e._.js.map