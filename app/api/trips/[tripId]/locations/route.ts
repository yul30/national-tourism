...
// POST /api/trips/[tripId]/locations - добавить локацию
export async function POST(
  ...
  try {
    ...
    const address = formData.get("address")?.toString() || locationTitle;
...
// GET /api/trips/[tripId]/locations - получить все локации
